...
#define Joint_Trajectory_Pub_Topic          "/trajectory_controller/command"
#define Joint_Trajectory_Sub_Topic          "/trajectory_controller/state"
#define Gripper_Pub_Topic                   "/gripper_controller/gripper_cmd/goal"
